...
export NAME_RUN=test-genomes-many
export CWL=$PIPELINE_FOLDER/workflows/sub-wf/sub-wf-many-genomes.cwl
export YML=$PIPELINE_FOLDER/workflows/sub-wf/many.yml
