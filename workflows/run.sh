...
export NAME_RUN=test-genomes-gtdbtk
export CWL=$PIPELINE_FOLDER/tools/gtdbtk/gtdbtk.cwl  #workflows/wf-test.cwl
export YML=$PIPELINE_FOLDER/tools/gtdbtk/test.yml #workflows/wf.yml
